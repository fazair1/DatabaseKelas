...
PembeliID CHAR(5) FOREIGN KEY REFERENCES Pembeli(PembeliID) ON UPDATE CASCADE ON DELETE CASCADE NOT NULL,
TanggalBayar DATE NOT NULL,
TotalBayar INT NOT NULL
)

CREATE TABLE Orderr(
OrderID CHAR(5) FOREIGN KEY REFERENCES Pembayaran(OrderID) ON UPDATE CASCADE ON DELETE CASCADE NOT NULL,
dvdID CHAR(6) FOREIGN KEY REFERENCES DVD(dvdID) ON UPDATE CASCADE ON DELETE CASCADE NOT NULL,
JumlahDVD INT CHECK (JumlahDVD > 0) NOT NULL
PRIMARY KEY(OrderID, dvdID)
)
